...
def get_displacement_atoms(ase_atom, supercell_n,is_diagonal=True,is_plusminus=False,distance=0.01):
    """
    ...
    phonon.generate_displacements(is_diagonal=is_diagonal, is_plusminus=is_plusminus, distance=distance)
